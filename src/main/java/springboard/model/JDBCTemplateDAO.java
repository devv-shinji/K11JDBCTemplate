	...
	*/
	...
	public JDBCTemplateDAO() {
		/*
			...
			즉, DB연결정보를 웹어플리케이션 어디서든 사용할수 있다.
		*/		
	...
	{	
		template.update(new PreparedStatementCreator() {			
			...
			public PreparedStatement 
				...
				bgroub(그룹번호)가 반드시 일치해야 한다. 
				또한 nextVal은 한문장에서 여러번 사용하더라도 같은 시퀀스를
				반환한다. 
				 */
	...
	public void updateHit(final String idx)
	{
		...
		/*
		매개변수로 전달되는 idx를 아래 익명클래스내부에서 사용하기
		위해서는 반드시 final로 선언해야 사용 가능하다. 
		(자바의 규칙)
		 */
	...
	public int password(String idx, String pass)
	{
		...
		try {
			...
			시퀀스를 사용하므로 항상 0보다는 큰 값을 가지게 된다. 
			 */
