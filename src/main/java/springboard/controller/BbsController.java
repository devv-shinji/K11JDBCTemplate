...
//	}
	...
	*/
	...
	public String list(Model model, HttpServletRequest req) {
		...
		이른 커맨드객체로 전달하기 위해 model에 저장후 매개변수로 
		전달한다. 
		 */
		model.addAttribute("req", req);
		
		/*
		컨트롤러는 사용자의 요청을 분석한후 해당 요청에 맞는 서비스객체만
		호출하고, 실제 DAO의 호출이나 비즈니스 로직은 아래 Command객체가 
		처리하게된다.  
		*/
	...
	public String editAction(HttpServletRequest req,Model model, 
		...
		반드시 필요하다. 이동시 쿼리스트링 형태로 redirect하지않고
